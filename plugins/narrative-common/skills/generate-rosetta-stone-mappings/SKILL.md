...
Step 2's describe response includes sample rows and column stats. If
you need more (richer histograms, a fresh sample, recomputed stats),
see [`references/SAMPLE_AND_STATS.md`](references/SAMPLE_AND_STATS.md)
for the sub-API calls.
...
- [`references/SAMPLE_AND_STATS.md`](references/SAMPLE_AND_STATS.md) — sub-API calls for fresh samples, histogram-bearing column stats, and stats recalculation. Read when step 2's bundled sample + stats don't suffice.
