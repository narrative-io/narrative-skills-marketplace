...
and the attribute-related step-5 CTEs (see Appendix C).
...
- Appendix A in this file — the macro table to substitute into the
  workflow YAML.
- Appendix B — `IDENTIFIER_ATTRIBUTE_IDS` lookup table used to
  partition AR mappings into identifiers vs enrichment.
