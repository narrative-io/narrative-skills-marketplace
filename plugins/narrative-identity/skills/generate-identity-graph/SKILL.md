...
> Apply the listed `WHERE`-clause conditions to each dataset as
> given — they're pre-flight audit filters and must be preserved
> verbatim (combine multiple conditions with `AND`):
>
