...
| `/suggest-compute-pool` | "which compute pool should I use", "suggest a compute pool", "what size compute pool do I need", "my job is too slow", "my job keeps failing", "job stuck in Pending", "right-size my compute pool", "will this query need a bigger pool". |
