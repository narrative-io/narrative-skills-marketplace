...
| `/create-cached-mapping` | "normalize these messy values into <attribute>", "set up a cached mapping", "clean up free-text <field> with an LLM", "fill the cache for <attribute>", "map raw values to the <attribute> enum". |
