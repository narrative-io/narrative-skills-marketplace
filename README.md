...
| `/suggest-compute-pool` | "are our compute pools set up right", "we're onboarding an account — what pools does it need", "we're bringing new workloads online", "which compute pool should I use", "what size compute pool do I need", "my job is too slow", "job stuck in Pending". |
